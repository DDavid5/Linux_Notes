...
#---Physical Volumes--
#z diskov môžeme vytvoriť Physical Volumes
lsblk #zobrazíme si disky
pvcreate /dev/sdb1 /dev/sbd2 #vyvoríme si PV z diskov
pvscan #zobrazíme PV
disktype /dev/sdb1 #zistime info o disku
#--- Volume Groups---
vgscan #oskneujem ci existuje VG
vgcreate GUEST_VG /dev/sdb1 /dev/sdb2 #vytovríme si VG z pred tým tvytvorenej PV
vgs #zobrazi info o VG
#--- Logical Volumes---
lvscan #zorbazime LV
lvcreate --name disk1 --size 20g GUEST_VG #vyvoríme LV s veľkosťou 20gb z volumeGrupy GUEST_VG
lvs #zobrazi info o LV
lvdisplay GUEST_VG/disk1 #detialy o LV
lvextend -L +20g --resziefs /name/of/LV
#---Snapshot of volumes---
#logicka kopia disku
lvcreate --size 5g --name snapshot-of-disk --snapshot /dev/GUEST_VG/disk1
#najprv musíme disk odpojit prikazom Umount
lvconvert --merge /dev/GUEST_VG/snapshot-of-disk #obnovime disk zo snapshotu
